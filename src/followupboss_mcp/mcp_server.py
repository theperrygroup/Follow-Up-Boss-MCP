    ...
    *,
    ...
    mcp = FollowUpBossFastMCP(
        ...
        instructions=(
            ...
            "no-communication, zero-communication, contacted-false, or needs-contact lead "
            "filter requests, use followupboss_list_uncontacted_leads rather than smart-list "
            "lookup unless the user explicitly says smart list or saved list. If a user asks "
