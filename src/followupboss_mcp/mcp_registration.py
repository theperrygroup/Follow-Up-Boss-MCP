...
def _register_people_tools(mcp: MCPServer, adapter: FollowUpBossToolAdapter) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "leads visible to the authenticated user. Known smart_list_id searches "
            "also default to the authenticated user's assigned leads unless "
            "assigned_user_id or include_ponds is explicit. Use this broad search for "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "Use this for uncontacted, never contacted, no communication, zero "
            "communication, hasn't communicated, or needs contact lead requests, "
            "including 'all my leads' wording. Use followupboss_search_people with "
            "contacted=false only when the user explicitly asks for the raw contacted "
            "field. "
