...
COVERAGE_MAP: dict[str, dict[str, str]] = {
    ...
    "GET /people/checkDuplicate": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Checks whether a person already exists by email address or phone number.",
        "tests": "Yes",
    },
    "GET /people/unclaimed": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Lists unclaimed leads available to the authenticated user.",
        "tests": "Yes",
    },
    "PUT /people/:id": {
        "implementation": "Implemented",
    ...
    "POST /people/claim": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Claims an offered lead and surfaces both success and already-claimed payloads.",
        "tests": "Yes",
    },
    "POST /people/ignoreUnclaimed": {
        ...
        "mcp": "Yes",
        "models": "Input only",
        "notes": "Acknowledges and ignores an unclaimed lead offer.",
        "tests": "Yes",
    },
    "DELETE /people/:id": {
        "implementation": "Implemented",
    ...
    "DELETE /dealCustomFields/:id": {
        ...
        "mcp": "Yes",
        "models": "Input only",
        "notes": "Deletes a deal custom field and returns structured deletion confirmation.",
        "tests": "Yes",
    },
    ...
    "GET /dealCustomFields/:id": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Fetches a single deal custom field by ID.",
        "tests": "Yes",
    },
    "POST /dealCustomFields": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Creates a deal custom field with the documented admin-only options.",
        "tests": "Yes",
    },
    "PUT /dealCustomFields/:id": {
        ...
        "mcp": "Yes",
        "models": "Yes",
        "notes": "Updates a deal custom field and preserves dropdown choice remapping support.",
        "tests": "Yes",
    },
    "GET /calls": {
        "implementation": "Implemented",
