    ...
    event: dict[str, object] = {
        "exception": {
            "values": [
                ...
                {
                    "type": "ToolError",
                    "value": f"Error executing tool followupboss_add_note: {message}",
                    "mechanism": {"handled": True},
                },
            ]
        },
        ...
        "exception": {
            "values": [
                ...
                },
                {
                    ...
                    "value": "Error executing tool followupboss_add_note",
                    "mechanism": {"handled": True},
                },
            ]
        },
    ...
    assert (
        observability._is_expected_typed_client_chain(  # pyright: ignore[reportPrivateUsage]
            [
                ...
                {
                    "type": "ToolError",
                    "value": "Error executing tool followupboss_add_note: something else",
                    "mechanism": {"handled": True},
                },
            ],
            error_type="FollowUpBossNotFoundError",
