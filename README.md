...
- typed services for Identity, People, Events, Users, Custom Fields, Deals, Groups, Pipelines, Ponds, Smart Lists, Stages, Appointments, Appointment Outcomes, Appointment Types, Calls, Tasks, Teams, Templates, Text Messages, Notes, and Webhooks
