...
- typed services for Identity, People, People Relationships, Person Attachments, Events, Users, Custom Fields, Deals, Deal Attachments, Email Marketing, Groups, Inbox Apps, Pipelines, Ponds, Smart Lists, Stages, Action Plans, Appointments, Appointment Outcomes, Appointment Types, Automations, Calls, Tasks, Team Inboxes, Teams, Templates, Text Messages, Notes, and Webhooks
